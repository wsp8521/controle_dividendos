...
def capture_old_proventos(sender, instance, **kwargs):
    ...
    # Atualiza o status para "PAGO" para o usuário logado, se a data de pagamento for menor ou igual a hoje
    if instance.fk_user and instance.status == "A PAGAR" and instance.data_pgto <= now().date():
