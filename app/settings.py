...
SECRET_KEY = 'django-insecure-mg4%=kwaln_o#o1@2s&l_#j4$9ho^7-_ftg7yy7pi6zy^(emvw'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = (BASE_DIR/'base_statics/',)
#STATIC_ROOT=os.path.join(BASE_DIR,'static/') #modo deployment
...
# Configuração do Redis para armazenar resultados de tarefas
LOGGING = {
    'version': 1,
